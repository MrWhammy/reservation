package eu.yperman.brecht.reservation.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, eu.yperman.brecht.reservation.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, eu.yperman.brecht.reservation.repository.UserRepository.USERS_BY_EMAIL_CACHE);
